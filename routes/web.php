...
$router->get('vehiculos/{id}/herramientas', [VehiculoController::class, 'apiHerramientas'], $auth);
...
$router->get('inspecciones/{id}/edit', [InspeccionController::class, 'edit'], $perm('inspecciones.update'));
$router->post('inspecciones/{id}', [InspeccionController::class, 'update'], $perm('inspecciones.update'));
...
$router->get('catalogos/servicios', [ServicioController::class, 'index'], $perm('catalogos.read'));
$router->get('catalogos/servicios/create', [ServicioController::class, 'create'], $perm('catalogos.create'));
$router->post('catalogos/servicios', [ServicioController::class, 'store'], $perm('catalogos.create'));
$router->get('catalogos/servicios/{id}/edit', [ServicioController::class, 'edit'], $perm('catalogos.update'));
$router->post('catalogos/servicios/{id}', [ServicioController::class, 'update'], $perm('catalogos.update'));
$router->post('catalogos/servicios/{id}/toggle', [ServicioController::class, 'toggle'], $perm('catalogos.update'));
$router->post('catalogos/servicios/{id}/eliminar', [ServicioController::class, 'destroy'], $perm('catalogos.update'));
